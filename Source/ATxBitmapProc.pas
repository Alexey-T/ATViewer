{
This unit was originally named GraphFlip.pas, it's renamed to avoid
...
function ConvertBmpToSepia(bmp: TBitmap; depth: Integer = 20): Boolean;
...
//This function adds a sepia effect to a **grayscale** bitmap.
