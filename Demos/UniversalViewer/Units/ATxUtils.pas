...
function FTempText: WideString;
function FTempClip(const Ext: WideString): WideString;      //Clipboard file name (in %Temp%)
...
function FTempText: WideString;
begin
  Result := FTempPath + 'UV_conv.txt';
end;

function FTempClip(const Ext: WideString): WideString;
begin
  Result := FTempPath + 'Clipboard' + Ext;
end;
