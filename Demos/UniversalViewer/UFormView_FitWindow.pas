//-----------------------
procedure MsgCopyMoveError(const OldName, NewName: WideString; h: THandle);
begin
  MsgError(
    SFormatW(MsgViewerCopyMoveError, [SExtractFileName(OldName), NewName])
    + #13#13 + MsgString(313), h);
end;

procedure MsgDeleteError(const OldName: WideString; h: THandle);
begin
  MsgError(
    SFormatW(MsgViewerDeleteError, [SExtractFileName(OldName)])
    + #13#13 + MsgString(313), h);
end;
